...
import { updateEtat, deleteAnnonce } from "../../features/annonces/annoncesSlice";
import { selectAllAnnonces } from "../../features/annonces/annoncesSelectors";
import { updateAdStatus, deleteAd } from "../../services/api/adsService";
  ...
  return (
    <div>
      <div className="flex justify-between items-center" style={{ marginBottom: "24px" }}>
        <div>
           <h2 style={{ fontSize: "24px", fontWeight: "700" }}>Marketplace Queue</h2>
           <p className="text-muted" style={{ fontSize: "14px" }}>Moderation and content management</p>
        </div>
                ...
                <tr key={ad.id} style={{ borderBottom: "1px solid var(--border-light)" }}>
                  ...
                  <td style={{ padding: "14px 20px", textAlign: "right" }}>
                    <div className="flex gap-2" style={{ justifyContent: "flex-end" }}>
                      ...
                      <button onClick={() => handleDelete(ad.id)} className="btn btn-ghost" style={{ padding: "5px 10px", fontSize: "12px" }}>Delete</button>
                    </div>
                  </td>
                </tr>
              ))
